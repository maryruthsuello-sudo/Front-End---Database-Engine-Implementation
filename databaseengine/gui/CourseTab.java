...
public class CourseTab extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        CT_Table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {},
            new String [] {
                "Program", "Subject Code", "Units", "Title"
            }
        ));
    ...
    private void CT_UpdateActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String oldSubjectCode = selectedCourse.getSubjectCode();
        ...
        boolean success = db.getCourse().updateCourse(updatedCourse, oldSubjectCode);
        if (!success) {
